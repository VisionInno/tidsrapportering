...
import { TimeEntryForm, TimeEntryList, Summary, ExportButton, ProjectManager, QuickTimer, TodayEntries, DataManager, FortnoxSettings } from './components'
...
function App() {
  const [showFortnoxSettings, setShowFortnoxSettings] = useState(false)
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {isElectron() && (
              <button
                onClick={() => setShowFortnoxSettings(true)}
      ...
      <FortnoxSettings show={showFortnoxSettings} onClose={() => setShowFortnoxSettings(false)} />
